...
Globe_RecVsDeath_fig <- Globe_Rcvd_fig %>%
  add_trace(x=~Global_count$Date,y=~Global_count$Deaths,mode="lines", fill = "tonexty",name="Deaths")

fig1<-Global_count %>%
  plot_ly(x = ~Date, y = ~Global_count$Recovered, mode = "lines",name='Recovered')

fig1 %>% add_trace(x=~Global_count$Date,y=~Global_count$Deaths,name="Deaths",
                   mode="lines",fill="tonexty") %>% add_trace(x = Global_count~Date, y = ~Global_count$Recovered, mode = "lines",name='Recovered',fill="tonexty")
...
fig1 %>% add_trace(Ita_stats,y=~Date,x=~`% change`,mode="markers")
